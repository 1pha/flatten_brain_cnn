...
class ConvNet(nn.Module):
    ...
    def __init__(self, ctype, kernel_size=3, stride=2):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(6, 16, kernel_size=self.kernel_size, stride=self.stride),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Dropout(.2),
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(16, 32, kernel_size=self.kernel_size, stride=self.stride),
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Dropout(.2),
            nn.MaxPool2d(kernel_size=2, stride=2)
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(32, 64, kernel_size=self.kernel_size, stride=self.stride),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Dropout(.2),
            nn.MaxPool2d(kernel_size=2, stride=2)
        ...
        if kernel_size in [5, 7]:
            self.flat_nodes = 3 * 4 * 64

        elif kernel_size == 3:
            self.flat_nodes = 4 * 5 * 64
